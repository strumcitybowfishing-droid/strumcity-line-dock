...
const CACHE_NAME = 'strumcity-shell-v20250606';
const PRECACHE_URLS = [
  './',
  './index.html',
  './css/styles.css?v=20250606',
  './js/app.js?v=20250606',
  './js/config.js?v=20250606',
  './js/weather.js?v=20250606',
  './js/utils.js?v=20250606',
  './js/tra.js?v=20250606',
  './js/charts.js?v=20250606',
  './js/charter.js?v=20250606',
  './js/gauge.js?v=20250606',
  './js/maps.js?v=20250606',
  './js/gallery.js?v=20250606',
