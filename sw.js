...
const CACHE_NAME = 'strumcity-shell-v20250609';
const PRECACHE_URLS = [
  './',
  './index.html',
  './css/styles.css?v=20250609',
  './js/app.js?v=20250609',
  './js/config.js?v=20250609',
  './js/weather.js?v=20250609',
  './js/utils.js?v=20250609',
  './js/tra.js?v=20250609',
  './js/charts.js?v=20250609',
  './js/charter.js?v=20250609',
  './js/gauge.js?v=20250609',
  './js/maps.js?v=20250609',
  './js/gallery.js?v=20250609',
