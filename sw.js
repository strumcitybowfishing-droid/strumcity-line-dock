...
const CACHE_NAME = 'strumcity-shell-v20250620';
const PRECACHE_URLS = [
  './',
  './index.html',
  './css/styles.css?v=20250620',
  './js/app.js?v=20250620',
  './js/config.js?v=20250620',
  './js/weather.js?v=20250620',
  './js/utils.js?v=20250620',
  './js/tra.js?v=20250620',
  './js/charts.js?v=20250620',
  './js/charter.js?v=20250620',
  './js/gauge.js?v=20250620',
  './js/maps.js?v=20250620',
  './js/gallery.js?v=20250620',
